  ...
  return (
    <div className="mb-8">
      <div className="flex items-center justify-between mb-4">
        ...
        <button onClick={onViewMore} className="text-sm text-blue-600 hover:underline">View more</button>
      </div>
      {items.length > 0 ? (
                ...
                <div className="space-y-3 text-sm">
                  ...
                  {camp.description && (
                    <div>
                      ...
                      <p className="text-gray-700 leading-snug">{camp.description}</p>
                    </div>
                  )}
                </div>
        ...
        <p className="text-gray-600">No recent camps.</p>
      )}
    </div>
  )
}

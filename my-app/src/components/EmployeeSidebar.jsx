...
export default function EmployeeSidebar({ user, isDarkMode, setIsDarkMode, onLogout }) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 h-screen transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${isDarkMode ? 'bg-gray-900' : 'bg-white'} border-r ${isDarkMode ? 'border-gray-700' : 'border-gray-200'} flex flex-col overflow-hidden`}>
        {/* Sidebar Header */}
        <div className={`flex items-center justify-between h-16 px-4 border-b ${isDarkMode ? 'border-gray-700' : 'border-gray-200'} flex-shrink-0`}>
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors ${
                    isActive
                      ? `${isDarkMode ? 'bg-green-900 text-green-300 border-r-2 border-green-700' : 'bg-green-50 text-green-700 border-r-2 border-green-700'}`
        ...
        {/* Sidebar Footer */}
        <div className={`flex-shrink-0 p-4 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-200'} bg-inherit`}>
          {/* Profile Section */}
          <div 
